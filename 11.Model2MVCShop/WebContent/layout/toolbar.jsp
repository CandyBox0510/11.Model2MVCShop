...
<div class="navbar  navbar-inverse navbar-fixed-top">
	...
	<div class="container">
   	...
   	<script type="text/javascript">
		...
		//=============  개인정보조회회 Event  처리 =============	
	 	$( "a:contains('개인정보조회'),a:contains('ID')" ).on("click" , function() {
	 		//==> DOM Object GET 3가지 방법 ==> 1. $(tagName) : 2.(#id) : 3.$(.className)
	 	...
	 	//=============  장바구니 보기  처리 =============	
	 	$( "a:contains('나의장바구니')" ).on("click" , function() {
			$(self.location).attr("href","/purchase/listWishPurchase");
		});
